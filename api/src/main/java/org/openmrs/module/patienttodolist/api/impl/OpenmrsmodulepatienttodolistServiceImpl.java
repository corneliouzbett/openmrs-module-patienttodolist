...
public class OpenmrsmodulepatienttodolistServiceImpl extends BaseOpenmrsService implements OpenmrsmodulepatienttodolistService {
	 ...
	 */
	public void setDao(OpenmrsmodulepatienttodolistDao dao) {
		this.dao = dao;
	}
