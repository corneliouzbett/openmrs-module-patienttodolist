...
/**
 * This is a unit test, which verifies logic in OpenmrsmodulepatienttodolistService. It doesn't
 * extend BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring
 * context.
 */
public class OpenmrsmodulepatienttodolistServiceTest {
	
	@InjectMocks
	OpenmrsmodulepatienttodolistServiceImpl basicModuleService;
	
	@Mock
	OpenmrsmodulepatienttodolistDao dao;
